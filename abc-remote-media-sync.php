<?php
/**
 * Plugin Name: ABC Remote Media Sync
 * Plugin URI: https://wordpress.org/plugins/abc-remote-media-sync/
 ...
 * Text Domain: abc-remote-media-sync
...
define('ABC_REMOTE_MEDIA_SYNC_PLUGIN_BASENAME', plugin_basename( __FILE__ ));
